...
TASK_TYPE_TO_TASK_NAME = {
    ...
    'sentiment': ['yelp', 'sentiment140', 'sst2', 'sst5', 'mr', 'subj'],#####
    'struct2text': ['common_gen', 'e2e_nlg', 'dart'],
    'summarize': ['aeslc', 'ag_news', 'gigaword', 'trec', 'yahoo'],
}
...
from .e2e_UDR import E2e
from .cnndailymail import Cnndailymail
from .java import Java
from .python import Python
from .pubmed import Pubmed
from .roc_story_generation import Roc_story_generation
from .roc_ending_generation import Roc_ending_generation
from .wikiauto import Wikiauto
...
#strip()去除decoded_text两段的空白字符，split('\n')按换行符将字符串拆分为1个列表
