...
def main():
    ...
    eval_dataset: Dataset = load_dataset(
        'json', data_files='{}/{}_{}.jsonl.gz'.format(args.data_dir,os.path.basename(args.model_name_or_path), args.llm_eval_split), split='train',download_mode='force_redownload')
